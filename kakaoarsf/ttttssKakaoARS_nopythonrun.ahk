...
global savebin := 1
global varTerm = "none"
global sleepTimeone := 500 ; 매크로 파일이기 때문에 코드 중간 지연 시간 (0.5초)을 넣어 코드끼리 충돌하는 것을 방지
global sleepTimetwo := 1000 ; 좀 더 긴 시간
global sleepTimelong := 2000 ; 시간이 좀 소요되는 코드를 위한 긴 지연 시간
;=================================================================================================================================
;=================================================================================================================================
start:
...
sleep, %sleepTimeone% ; 매크로가 겹치는 오류를 방지하기 위한 sleep 시간 (1000 = 1초)
...
loop, 5
{
	...
	Send, ^{s}
    Sleep, %sleepTimetwo%
	ControlClick, x436 y50, ahk_class #32770
    Sleep, %sleepTimeone%
	Send, %A_ScriptDir%\data
	Sleep, %sleepTimeone%
	Send, {Enter}
	Sleep, %sleepTimeone%
	Send, {Enter}
	...
	yl := yl + 75 ; y좌표를 더하여 아래 채팅방 목록에 아래 채팅방 접속
...
Run, %A_ScriptDir%\Anaconda Prompt (anaconda3)
sleep, %sleepTimetwo%
Send, cd %A_ScriptDir%
sleep, %sleepTimetwo%
send, {Enter}
...
if %dataupdate%
{
    ...
    SetTimer, RemoveTrayTip, %sleepTimetwo%
