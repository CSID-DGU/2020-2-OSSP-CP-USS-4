...
def john():
    ...
    f = open("text1.txt", "w", encoding = "utf-8-sig")
    f.write(sentence)
    f.close
...
def eorin_nom():
    ...
    f = open("text2.txt", "w", encoding="utf-8-sig")
    f.write(sentence)
    f.close
def johnbig():
...
if __name__ == "__main__":
    msg_list = read_kko_msg('C:/Users/Administrator/Desktop/kakaoarsf/data/merge.txt')
