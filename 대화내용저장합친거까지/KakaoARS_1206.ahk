...
Gui, Add, Edit, x332 y80 w80 h70 vEdit, 채팅방 이름을 입력해주신 후 아래 버튼을 눌러주세요. ;~ display a pop-up
Gui, Add, Button, x332 y150 w80 h35 vabout, 평균답장시간예측 ;~ display a pop-up
Gui, Add, Button, x332 y195 w80 h35 vquit, 종료`(&Q`) ;~ display a pop-up TBD
Gui, Show, x1 y1 w423 h240, KakaoARS
